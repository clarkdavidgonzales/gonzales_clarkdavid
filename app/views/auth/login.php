...
<body class="min-h-screen bg-gradient-to-br from-red-50 to-white flex items-center justify-center">
  ...
  <div class="hidden md:flex items-center justify-center bg-red-600 p-8">
      ...
      <div class="p-8">
        ...
        <form action="<?= site_url('login') ?>" method="POST" class="space-y-4">
          <div>
            ...
            <div class="relative">
              <input type="text" name="username" required class="w-full pl-10 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="admin">
          ...
          <div>
            ...
            <div class="relative">
              <input type="password" name="password" required class="w-full pl-10 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="••••••••">
              <span class="absolute left-3 top-2.5 text-gray-400">
          ...
          <div class="flex items-center justify-between">
            <label class="inline-flex items-center text-sm">
              <input type="checkbox" name="remember" class="form-checkbox h-4 w-4 text-red-600"> 
          ...
          <div>
            <button type="submit" class="w-full bg-red-600 text-white py-2 rounded-md font-semibold hover:bg-red-700 transition">Sign in</button>
          </div>
        </form>
